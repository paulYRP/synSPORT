"""
Prepare raw tabular datasets into the file layout expected by TabSyn.
...
def preprocess_beijing():
    """
    Description:
        Preprocess data for `preprocess_beijing`.
...
def preprocess_news():
    """
    Description:
        Preprocess data for `preprocess_news`.
...
def get_column_name_mapping(data_df, num_col_idx, cat_col_idx, target_col_idx, column_names = None):
    ...
    """
    Description:
        Return values for `get_column_name_mapping`.
...
def train_val_test_split(data_df, cat_columns, num_train = 0, num_test = 0):
    """
    Description:
        Train data for `train_val_test_split`.
