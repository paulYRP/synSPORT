"""
Compute and summarize predictive metrics for TabSyn experiments.
...
class MetricsReport:
    def __init__(self, report: dict, task_type: TaskType):
        """
        Description:
            Initialize `MetricsReport` with the parameters required by later methods.

        Input:
            report: dict; task_type: TaskType.
    ...
    def get_splits_names(self) -> list[str]:
        """
        Description:
            Return values for `get_splits_names`.
    ...
    def get_metrics_names(self) -> list[str]:
        """
        Description:
            Return values for `get_metrics_names`.
    ...
    def get_val_score(self) -> float:
        """
        Description:
            Return values for `get_val_score`.
    ...
    def get_test_score(self) -> float:
        """
        Description:
            Return values for `get_test_score`.
    ...
    def print_metrics(self) -> None:
        """
        Description:
            Print values for `print_metrics`.
...
class SeedsMetricsReport:
    def __init__(self):
        """
        Description:
            Initialize `SeedsMetricsReport` with the parameters required by later methods.
    ...
    def get_mean_std(self) -> dict:
        """
        Description:
            Return values for `get_mean_std`.
...
def calculate_rmse(
    ...
    """
    Description:
        Calculate values for `calculate_rmse`.

    Input:
        y_true: np.ndarray; y_pred: np.ndarray; std.
...
def _get_labels_and_probs(
    ...
    """
    Description:
        Return values for `_get_labels_and_probs`.
...
def calculate_metrics(
    ...
    Input:
        y_true: np.ndarray; y_pred: np.ndarray; task_type: Union[str, TaskType]; prediction_type: Optional[Union[str, PredictionType]]; y_info: Dict[str, Any].
