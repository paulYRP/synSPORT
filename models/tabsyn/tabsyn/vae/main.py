"""
Train the TabSyn variational autoencoder used to build latent representations.
...
def compute_loss(X_num, X_cat, Recon_X_num, Recon_X_cat, mu_z, logvar_z):
    """
    Description:
        Compute values for `compute_loss`.
...
def main(args):
    ...
    num_epochs = max(1, int(getattr(args, 'epochs', 4000)))
