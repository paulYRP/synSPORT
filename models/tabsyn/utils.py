"""
Provide TabSyn command dispatch and argument parsing helpers.
...
def execute_function(method, mode):
    """
    Description:
        Resolve and execute functions for `execute_function`.
    ...
    try:
        ...
        print(f"Failed while importing {module_name}: missing module '{e.name}'.")
        raise
